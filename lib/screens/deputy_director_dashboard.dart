...
class DeputyDirectorDashboard extends StatefulWidget {
  const DeputyDirectorDashboard({super.key});

  @override
  State<DeputyDirectorDashboard> createState() => _DeputyDirectorDashboardState();
}

class _DeputyDirectorDashboardState extends State<DeputyDirectorDashboard> {
...
void _showProfileSheet() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Deputy Director Dashboard"),
